...
public class CameraDialog extends DialogFragment implements DialogInterface.OnClickListener{
    ...
    public interface CameraDialogListeren {
        USBMonitor onGetUsbMonitor();
    ...
    public void onAttach(final Activity activity) {
        ...
        if (mUSBMonitor == null)
            try {
                mUSBMonitor = ((CameraDialogListeren) activity).onGetUsbMonitor();
        ...
        switch (which) {
            case DialogInterface.BUTTON_POSITIVE:
                ...
                if (item instanceof UsbDevice) {
                    ...
                    ((CameraDialogListeren) getActivity()).onDialogResult(false);
                }
                break;
            case DialogInterface.BUTTON_NEGATIVE:
                ((CameraDialogListeren) getActivity()).onDialogResult(true);
                break;
        }
    }
